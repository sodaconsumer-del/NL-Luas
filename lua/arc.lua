...
do
    ...
    v1490:switch("Reflex"):name(v82("binary", string.format("\a{Text Preview}%s Reflex", v0), 0, 17, nil, "\aB6B665FF")):tooltip("Improves PC responsiveness during a gameplay by dynamically adjusting CPU / IO priorities. (and a lot more behind the scenes)"):disabled(true);

	...
	W = {
	    apply = function(cmd)
	        ...
	        if  y == 1 then
				...
				refs.modifier:override("Center")
	    		refs.modoffset:override(-math.random(1, 22))
				rage.antiaim:override_hidden_yaw_offset(-75-math.random(0, 5))
				rage.antiaim:override_hidden_pitch(-math.random(51, 72))
	
			else 
				refs.yawoffset:override(-25)
				refs.modifier:override("Center")
	       		refs.modoffset:override(math.random(1, 22))
		 		rage.antiaim:override_hidden_yaw_offset(77+math.random(0, 5))
				rage.antiaim:override_hidden_pitch(-math.random(51, 72))
	    ...
	    rnd_min = math.random(4, 5),
        rnd_max =math.random(2, 4),
	},
}

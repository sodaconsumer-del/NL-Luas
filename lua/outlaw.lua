...
xpcall(function()
    ...
    do
        ...
        do
            ...
            if v0 ~= 3 then
                l_v579_1.group:button("\aAFAF62FF\239\131\129 \aDEFAULTFull Version Available in \aAFAF62FFELITE", v567("https://neverlose.cc/market/item?id=2nWGaE"), true);
            end;
            if v2 then
            ...
            l_v581_1 = function()
                ...
                if v0 == 3 then
                    ...
                    l_v579_1.debugger:disabled(true);
                    if l_v579_1.debugger:get() then
                        l_v579_1.debugger:set(false);
                    end;
                    l_v579_1.adaptive_safepoint_logic:disabled(true);
                    if #l_v579_1.adaptive_safepoint_logic:get() ~= 0 then
                        l_v579_1.adaptive_safepoint_logic:set({});
                    end;
                    l_v579_1.fast_quick_peeking:disabled(true);
                    if #l_v579_1.fast_quick_peeking:get() ~= 0 then
                        l_v579_1.fast_quick_peeking:set({});
                    end;
                    return;
                end;
            end;

...
local v3 = db["weapon_model_changer:9E?qy<NA)5.86=&RDhsQ"] or false;
...
local v16 = {
    ...
    [137] = {
        ...
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSGO%20-%20Jumpsuit%20(Black).zip"
    }, 
    [138] = {
        name = "CS:GO - FBI (Black)", 
        path = "models/player/custom_player/kirby/kumlafbi/kumlafbi.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSGO%20-%20FBI%20(Black).zip"
    }, 
    [139] = {
        name = "CS:GO (legacy) - FBI", 
        path = "models/player/custom_player/csgo_legacy/ctm_fbi.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSGO%20(legacy)%20-%20FBI.zip"
    }, 
    [140] = {
        name = "CS:GO (legacy) - Elite Crew (A)", 
        path = "models/player/custom_player/csgo_legacy/tm_leet_varianta.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSGO%20(legacy)%20-%20Elite%20Crew.zip"
    }, 
    [141] = {
    ...
    [145] = {
        ...
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Arctic.zip"
    }, 
    [146] = {
        name = "CS:S - Elite Crew", 
        path = "models/player/custom_player/eminem/css/t_leet.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Elite%20Crew.zip"
    }, 
    [147] = {
        name = "CS:S - Elite Crew (Black)", 
        path = "models/player/custom_player/kirby/umbrella_leet/umbrella_leet3.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Elite%20Crew%20(Black).zip"
    }, 
    [148] = {
        name = "CS:S - Guerilla", 
        path = "models/player/custom_player/eminem/css/t_guerilla.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Guerilla.zip"
    }, 
    [149] = {
        name = "CS:S - Phoenix", 
        path = "models/player/custom_player/eminem/css/t_phoenix.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Phoenix.zip"
    }, 
    [150] = {
        name = "CS:S - Phoenix (Black)", 
        path = "models/player/custom_player/kirby/kirbys_robber/kirbys_robber2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Phoenix%20(Black).zip"
    }, 
    [151] = {
        name = "CS:S - GIGN", 
        path = "models/player/custom_player/eminem/css/ct_gign.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20GIGN.zip"
    }, 
    [152] = {
        name = "CS:S - GSG9", 
        path = "models/player/custom_player/eminem/css/ct_gsg9.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20GSG9.zip"
    }, 
    [153] = {
        name = "CS:S - SAS", 
        path = "models/player/custom_player/eminem/css/ct_sas.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20SAS.zip"
    }, 
    [154] = {
        name = "CS:S - Urban", 
        path = "models/player/custom_player/eminem/css/ct_urban.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSS%20-%20Urban.zip"
    }, 
    [155] = {
        name = "CS:O - Lisa", 
        path = "models/player/custom_player/kuristaja/cso2/lisa/lisa.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Lisa.zip"
    }, 
    [156] = {
        name = "CS:O - Mila", 
        path = "models/player/custom_player/kuristaja/cso2/mila/mila.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Mila.zip"
    }, 
    [157] = {
        name = "CS:O - Karachenko", 
        path = "models/player/custom_player/kuristaja/cso2/karachenko/karachenko.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Karachenko.zip"
    }, 
    [158] = {
        name = "CS:O - Helga", 
        path = "models/player/custom_player/kuristaja/cso2/helga/helga.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Helga.zip"
    }, 
    [159] = {
        name = "CS:O - Natalie", 
        path = "models/player/custom_player/kuristaja/cso2/natalie/natalie.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Natalie.zip"
    }, 
    [160] = {
        name = "CS:O - Miyu", 
        path = "models/player/custom_player/kuristaja/cso2/miyu_schoolgirl/miyu.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CSO%20-%20Miyu.zip"
    }, 
    [161] = {
        name = "CS - Arctic Avenger (A)", 
        path = "models/player/custom_player/legacy/tm_arctic_varianta.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/CS%20-%20Arctic%20Avenger%20(A).zip"
    }, 
    [162] = {
        name = "TF2 - Sniper (Blue)", 
        path = "models/player/custom_player/kuristaja/tf2/sniper/sniper_bluv2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/TF2%20-%20Sniper%20(Blue).zip"
    }, 
    [163] = {
        name = "TF2 - Sniper (Red)", 
        path = "models/player/custom_player/kuristaja/tf2/sniper/sniper_redv2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/TF2%20-%20Sniper%20(Red).zip"
    }, 
    [164] = {
        name = "GTA - Homeless", 
        path = "models/player/custom_player/eminem/gta_sa/swmotr5.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Homeless.zip"
    }, 
    [165] = {
        name = "GTA - Homeless (Box)", 
        path = "models/player/custom_player/madebyruzh/homeless/homeless.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Homeless%20(Box).zip"
    }, 
    [166] = {
        name = "GTA - Ballas", 
        path = "models/player/custom_player/kolka/ballas/ballas.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Ballas.zip"
    }, 
    [167] = {
        name = "GTA - Ballas 1", 
        path = "models/player/custom_player/frnchise9812/ballas1.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Ballas%201.zip"
    }, 
    [168] = {
        name = "GTA - Ballas 1 (Black)", 
        path = "models/player/custom_player/frnchise9812/ballas2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Ballas%201%20(Black).zip"
    }, 
    [169] = {
        name = "GTA - Ballas 1 (Wraith)", 
        path = "models/player/custom_player/caleon1/ballas1/ballas1.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Ballas%201%20(Wraith).zip"
    }, 
    [170] = {
        name = "GTA - Tommy", 
        path = "models/player/custom_player/nf/gta/tommi.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Tommy.zip"
    }, 
    [171] = {
        name = "GTA - VLA2", 
        path = "models/player/custom_player/eminem/gta_sa/vla2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20VLA2.zip"
    }, 
    [172] = {
        name = "GTA - Fam1", 
        path = "models/player/custom_player/eminem/gta_sa/fam1.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Fam1.zip"
    }, 
    [173] = {
        name = "GTA - Bmybar", 
        path = "models/player/custom_player/eminem/gta_sa/bmybar.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Bmybar.zip"
    }, 
    [174] = {
        name = "GTA - Somyst", 
        path = "models/player/custom_player/eminem/gta_sa/somyst.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Somyst.zip"
    }, 
    [175] = {
        name = "GTA - Vwfypro", 
        path = "models/player/custom_player/eminem/gta_sa/vwfypro.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Vwfypro.zip"
    }, 
    [176] = {
        name = "GTA - Bloods", 
        path = "models/player/custom_player/z-piks.ru/gta_blood.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Bloods.zip"
    }, 
    [177] = {
        name = "GTA - Crips", 
        path = "models/player/custom_player/z-piks.ru/gta_crip.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Crips.zip"
    }, 
    [178] = {
        name = "GTA - Ryder", 
        path = "models/player/custom_player/madebyruzh/ryder/ryder.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Ryder.zip"
    }, 
    [179] = {
        name = "GTA - Sweet", 
        path = "models/player/custom_player/madebyruzh/sweet/sweet.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Sweet.zip"
    }, 
    [180] = {
        name = "GTA - Fam2", 
        path = "models/player/custom_player/frnchise9812/fam2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/GTA%20-%20Fam2.zip"
    }, 
    [181] = {
        name = "Matrix - Neo", 
        path = "models/player/custom_player/eminem/gta_sa/wuzimu.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Matrix%20-%20Neo.zip"
    }, 
    [182] = {
        name = "MW - SAS Assault William", 
        path = "models/player/custom_player/darnias/sas_william_fix.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/MW%20-%20SAS%20Assault%20William.zip"
    }, 
    [183] = {
        name = "DNF - Duke Nukem", 
        path = "models/player/custom_player/kuristaja/duke/dukev3.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/DNF%20-%20Duke%20Nukem.zip"
    }, 
    [184] = {
        name = "L4D2 - Ellis", 
        path = "models/player/custom_player/kuristaja/l4d2/ellis/ellisv2.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/L4D2%20-%20Ellis.zip"
    }, 
    [185] = {
        name = "Valorant - Jett", 
        path = "models/player/custom_player/night_fighter/valorant/jett/jett.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Valorant%20-%20Jett.zip"
    }, 
    [186] = {
        name = "RE2 - Hunk", 
        path = "models/player/custom_player/darnias/hunk/hunk.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/RE2%20-%20Hunk.zip"
    }, 
    [187] = {
        name = "RE6 - Chris Redfield", 
        path = "models/player/custom_player/kuristaja/re6/chris/chrisv4.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/RE6%20-%20Chris%20Redfield.zip"
    }, 
    [188] = {
        name = "Special Forces - MPSSC", 
        path = "models/player/custom_player/legacy/ctm_mpssc_variantc.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Special%20Forces%20-%20MPSSC.zip"
    }, 
    [189] = {
        name = "Special Forces - KSK", 
        path = "models/player/custom_player/legacy/ctm_ksk.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Special%20Forces%20-%20KSK.zip"
    }, 
    [190] = {
    ...
    [194] = {
        ...
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Anime%20-%20Compa.zip"
    }, 
    [195] = {
        name = "Anime - Hatsune Miku (Gothic)", 
        path = "models/player/custom_player/uuz/gothic_miku/gothic_miku.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Anime%20-%20Hatsune%20Miku%20(Gothic).zip"
    }, 
    [196] = {
        name = "Celebrity - Andrew Tate (NL)", 
        path = "models/player/custom_player/frnchise9812/neverlosee.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Celebrity%20-%20Andrew%20Tate%20(NL).zip"
    }, 
    [197] = {
        name = "Celebrity - Andrew Tate (GS)", 
        path = "models/player/custom_player/frnchise9812/gamesensee.mdl", 
        files = "https://gitlab.com/mogel/models/-/raw/main/agents/Celebrity%20-%20Andrew%20Tate%20(GS).zip"
    }
};
local v17 = {
    attachment_hider = {
...
v24.home.group_top = {
    ui.create(v22["house-user"] .. v23.default .. "  Home", "top", 1)
};
v24.home.group_top.user_info = v24.home.group_top[1]:label("Welcome back, ...");
v24.home.group_top.lua_version = v24.home.group_top[1]:label("");
v24.home.group_top.lua_link = v24.home.group_top[1]:button("   " .. v22["rectangle-history"] .. "   ", function()
...
v24.home.group_bottom = {
    ui.create(v22["house-user"] .. v23.default .. "  Home", "bottom", 1)
};
v24.home.group_bottom.discord_label = v24.home.group_bottom[1]:label("Discord - Community");
v24.home.group_bottom.discord_invite_button = v24.home.group_bottom[1]:button("join server", function()
...
local function v45(v44)
    -- upvalues: l_manager_0 (ref), v18 (ref)
    if not l_manager_0.exists(v18.game_dir .. "/" .. v44.path) then
        l_manager_0.download(v44.files, v18.game_dir .. "/temp.zip");
        l_manager_0.extract(v18.game_dir .. "/temp.zip", v18.game_dir);
        l_manager_0.delete(v18.game_dir .. "/temp.zip");
    end;
end;
...
local function v92(v90, v91)
    -- upvalues: v18 (ref), l_manager_0 (ref), v85 (ref), v17 (ref)
    if type(v90) == "string" and string.find(v90, "%.mdl") then
        v90 = transform_slashes(v90);
        if files.read(v18.game_dir .. "/" .. v90) or l_manager_0.exists(v18.game_dir .. "/" .. v90) then
            return true;
        end;
    end;
    if v91 == "mask" then
...
local function v125()
    ...
    if ui.get_alpha() > 0 then
        ...
        v24.home.group_top[1]:parent():name(v23.primary .. v22["house-user"] .. v23.default .. "  Home");
        v24.home.group_top[1]:name("");
        v24.home.group_top.user_info:name(v23.primary .. v22.user .. v23.default .. "    Welcome back, " .. v23.primary .. common.get_username());
        v24.home.group_top.lua_version:name(v23.primary .. v22["code-branch"] .. v23.default .. "    Release  -  " .. v23.primary .. "3.2.9");
        v24.home.group_bottom[1]:name("\n");
        v24.home.group_bottom.discord_label:name(v23.primary .. v22.discord .. v23.default .. "    Community                                                         ");
        v24.home.group_bottom.discord_invite_button:name("     " .. v23.primary .. v22["right-to-bracket"] .. v23.default .. "  Join server     ");

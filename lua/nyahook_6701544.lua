...
local menu = { } do
    ...
    menu.home = 
    {
        ...
        welcome = menu.tabs.home.nyahook:label("Welcome to the \vBeta\r version of \vNyaHook\r!"),

        user = menu.tabs.home.under_nyahook:label(menu.icon_text("hand-wave", "Welcome back, \v" .. common.get_username())),
        current_build = menu.tabs.home.under_nyahook:label(menu.icon_text("rectangle-terminal", "Current build: \vBeta")),
    ...
    visuals.watermark = function()
        ...
        if not menu.visuals.watermark:get() then 
            ...
            if menu.visuals.watermark.style:get() == "Modern" then 
                ...
                render.text(2, vector(render.measure_text(2, nil, "nya").x + 38, screen_y / 2 + 26), color(255), nil, "hook [Beta]")
            ...
            elseif menu.visuals.watermark.style:get() == "Minimalistic" then
                render.text(1, vector(screen_x - render.measure_text(1, nil, "nyahook ~ beta : username: " .. common.get_username()).x - 7, 5), watermark_color, nil, "nya")
                render.text(1, vector(screen_x - render.measure_text(1, nil, "hook ~ beta : username: " .. common.get_username()).x - 7, 5), color(255), nil, "hook ~ beta : username: " .. common.get_username())
